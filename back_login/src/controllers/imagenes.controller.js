...
class ImagenesController {
    ...
    // CRUD completo para manejar imagenes (binario y base64)
    async procesarImagen(tabla, campoId, id, imagenBase64 = null) {
        if (imagenBase64) {
            //Si laimagen es proporcionada en base64, guardamos  actulizamos
            return await this.subirImagen(tabla, campoId, id, imagenBase64);
        } else {
            // Si no se proporcona imagen, solo obtenemos la imagen en base64
